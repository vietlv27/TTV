...
CREATE TABLE customers (
  ...
  customer_type VARCHAR(50) DEFAULT 'KH thường',
  note TEXT,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB;
...
CREATE TABLE projects (
  ...
  priority_level VARCHAR(30) NOT NULL DEFAULT 'Cấp 4 - Low',
  priority_score INT NOT NULL DEFAULT 0,
  customer_level VARCHAR(50) DEFAULT 'KH thường',
  received_date DATE DEFAULT NULL,
  project_deadline DATE DEFAULT NULL,
  request_description TEXT,
  project_status VARCHAR(100) NOT NULL DEFAULT 'Đang tiếp cận, tư vấn',
  risk_note TEXT,
...
CREATE TABLE project_items (
  ...
  item_status VARCHAR(50) DEFAULT 'Đang xử lý',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE tasks (
  ...
  task_status VARCHAR(50) NOT NULL DEFAULT 'Chưa làm',
  task_priority VARCHAR(30) DEFAULT 'Medium',
